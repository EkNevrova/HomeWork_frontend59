...
const makeOne = () => {
	const num1 = 5;
	const num2 = 10;
	resultOne.textContent = Number(num1 + num2);
};
...
const makeTwo = () => {
	const num1 = 20;
	const num2 = 7;
	resultTwo.textContent = Number(num1 - num2);
};
...
const makeThree = () => {
	const num1 = 8;
	const num2 = 4;
	resultThree.textContent = Number(num1 * num2);
};
...
const makeFour = () => {
	const num1 = 16;
	const num2 = 2;
	resultFour.textContent = Number(num1 / num2);
};
...
const makeFive = () => {
	const num = 3;
	const power = 4;
	resultFive.textContent = Math.pow(num, power); //Number(num ** power);
};
...
const makeSix = () => {
	const num1 = 20;
	const num2 = 5;
	resultSix.textContent = Number(num1 % num2);
};
...
const makeSeven = () => {
	const num1 = 25;
	const num2 = 7;
	resultSeven.textContent = Number(num1 % num2);
};
...
const makeEight = () => {
	const num1 = 123;
	resultEight.textContent = Number(num1 % 10);
};
...
const makeNine = () => {
	const num1 = 4567;
	resultNine.textContent = Number(num1 % 100);
};
...
const makeEleven = () => {
	resultEleven.textContent = Number(5 % 2);
};
...
const makeSeventeen = () => {
	const str = 'JavaScript';
	resultSeventeen.textContent = str.substring(3, 7 - 1);
};
...
const makeEighteen = () => {
	...
	const strNew = str.replace(/world/gi, 'JavaScript');
	resultEighteen.textContent = strNew;
};
...
const makeTwentySeven = () => {
	resultTwentySeven.textContent = Math.round((1 + Math.random()) * 50);
};
