...
function makeOne() {
	document.getElementById('practicum').textContent = 'Привет!';
}
...
function makeNine() {
	...
	item.innerHTML = 'Новый вариант';
	document.getElementById('practicum9').append(item);
}
...
function makeEleven() {
	const square11 = document.getElementById('practicum11');
	square11.style.width = '400px';
	square11.style.height = '200px';
}
...
function makeTwelve() {
	document.querySelector('#practicum12').classList.toggle('resizeable.large');
	// !!! НЕ РАБОТАЕТ !!!
}
...
function makeTwenty() {
	const pr20 = document.getElementById('practicum20');
	let newParagraph = document.createElement('p');
	newParagraph.textContent = 'Добавлено в начало';
	pr20.prepend(newParagraph);
}
...
function makeTwentyOne() {
	...
	document.getElementById('practicum21').append(newParagraph);
}
...
function makeTwentyTwo() {
	const pr22 = document.getElementById('practicum22');
	let atribute22 = pr22.hasAttribute('src');
	document.getElementById('result22').textContent = 'Атрибут "src" присутствует: ' + atribute22;
}
...
function makeTwentyFour() {
	document.getElementById('practicum24').value = 'Новое значение';
}
...
function makeTwentyFive() {
	const pr25 = document.getElementById('practicum25');
	pr25.setAttribute('data-info', 'Дополнительная информация');
	let atribute25 = pr25.getAttribute('data-info');
	document.getElementById('infoOutput').textContent = 'Добавленный атрибут: ' + atribute25;
}
...
function makeTwentySeven() {
	...
	const pr27 = document.getElementById('practicum27').classList.contains('highlight');
	document.getElementById('result').textContent = 'Наличие класса у элемента: ' + pr27;
...
document.getElementById('div30').addEventListener('mouseover', handleMouseOver);
