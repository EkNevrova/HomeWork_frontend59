...
console.log(`Полное имя: ${worker2.fullName()}`);
...
const mazda = new Car('Mazda', 'CX-9', '2022');
//Выводим созданный объект в консоль
console.log(mazda);
...
console.log(`Возраст автомобиля: ${car2.getAge()}`);
...
console.log(`Rectangle width: ${rectangle.width};Rectangle height: ${rectangle.height}`);
...
const rectangle2 = new Rectangle(30, 15);
...
console.log(`Circle area: ${circle2.calculateArea()}`);
...
const student = new Student('Jhon', 21, 6);
...
const student2 = new Student('Anna', 20, 7);
console.log(`student name: ${student2.name}, age: ${student2.age}, grade: ${student2.increaseGrade()}`);
...
const book = new Book('Шинель', 'Н.В. Гоголь', 1842);
...
const book2 = new Book('Мастер и Маргарита', 'М.А. Булгаков', 1940);
...
const account = new BankAccount('LEI 253400V1H6ART1UQ0N98', 150000);
console.log(`Bank account Number: ${account.accountNumber}, balance: ${account.balance}`);
...
BankAccount.prototype.deposit = function (deposSum) {
	return this.balance = this.balance + deposSum;
}
const account2 = new BankAccount('LEI 253400V1H6ART1UQ0N98', 150000);
console.log(`Bank account Number: ${account2.accountNumber}, balance: ${account2.deposit(70000)}`);
...
const account3 = new BankAccountNew(150000);
console.log(account3.withdraw(110000));
...
const animal = new Animal('dog', 'barking');
console.log(`Animal: ${animal.name} sound: ${animal.sound}`);
...
const animal2 = new Animal('dog', 'barking');
animal2.makeSound();
...
console.log(`Distance = ${point2.getDistance()}`);
...
const calculator = new Calculator(25, 5);
console.log('calculator add:' + calculator.add());
console.log('calculator substract:' + calculator.substract());
console.log('calculator multiply:' + calculator.multiply());
console.log('calculator divide:' + calculator.divide());
...
const person = new Person('Jhon', 21, 'Moscow');
...
const person2 = new Person('Jhon', 21, 'Moscow');
...
const employee = new Employee('Jhon', 'manager', 110000);
employee.showing();
...
Employee.prototype.calculateBonus = function (bonus) {
	this.salary = this.salary * (bonus + 100 / 100);
}
const employee2 = new Employee('Bill', 'director', 210000);
...
const product = new Product('merche', 11000, 7);
product.showing();
...
Product.prototype.calculateTotalPrice = function () {
	console.log(`TotalPrice: ${this.price * this.quantity}`);
}
const product2 = new Product('merche2', 10000, 5);
product2.showing();
...
class Triangle {
	...
	showing() {
		console.log(`Triangle side1: ${this.side1}, side2: ${this.side2}, side3: ${this.side3}`);
	}
}
const triangle = new Triangle(5, 3, 2);
triangle.showing();
...
Triangle.prototype.calculatePerimeter = function () {
	console.log(`Perimeter: ${this.side1 + this.side2 + this.side3}`);
}
const triangle2 = new Triangle(6, 5, 4);
...
console.log(`Square side: ${square2.side}, area: ${square2.calculateArea()}`);